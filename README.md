...
* Finally, the Unipept API can be started with this command: `./target/release/unipept-api -i "/unipept-index-data" -d "mysql://root:unipept@127.0.0.1:3306/unipept" -p 80`.
