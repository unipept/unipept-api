...
use super::lineage_helper::{get_amount_of_ranks, get_lineage_array, LineageVersion};

pub mod node;
pub mod frequency;

pub fn build_tree(frequencies: FrequencyTable<u32>, version: LineageVersion, lineage_store: &LineageStore, taxon_store: &TaxonStore) -> Node {
