...
pub fn create_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .layer(
            ServiceBuilder::new()
                // CORS must be the outermost layer so that Access-Control-* headers are also
                // attached to responses generated by the layers below (e.g. a request timeout
                // or a body-size rejection), not just to responses coming from the route handlers.
