...
ActiveRecord::Schema[7.0].define(version: 0) do
  ...
  create_table "dataset_items", id: :integer, auto_increment: true, force: :cascade do |t|
    t.bigint "dataset_id"
  ...
  create_table "datasets", id: :integer, auto_increment: true, force: :cascade do |t|
  ...
  create_table "ec_cross_references", id: :bigint, auto_increment: true, force: :cascade do |t|
  ...
  create_table "ec_numbers", id: :integer, auto_increment: true, force: :cascade do |t|
    t.string "code", limit: 15, null: false
    t.string "name", limit: 155, null: false
    t.index ["code"], name: "idx_ec_numbers_code"
  end

  create_table "go_cross_references", id: :bigint, auto_increment: true, force: :cascade do |t|
    t.bigint "uniprot_entry_id", null: false
    t.string "go_term_code", limit: 15, null: false
    t.index ["uniprot_entry_id"], name: "idx_go_cross_references_uniprot_entry_id"
  end

  create_table "go_terms", id: :integer, auto_increment: true, force: :cascade do |t|
    t.string "code", limit: 15, null: false
  ...
  create_table "interpro_cross_references", id: :bigint, auto_increment: true, force: :cascade do |t|
    t.bigint "uniprot_entry_id", null: false
  ...
  create_table "interpro_entries", id: :integer, auto_increment: true, force: :cascade do |t|
    t.string "code", limit: 9, null: false
    t.string "category", limit: 32, null: false
    t.string "name", limit: 160, null: false
  end

  create_table "lineages", primary_key: "taxon_id", id: :integer, auto_increment: true, force: :cascade do |t|
  ...
  create_table "peptides", id: :bigint, auto_increment: true, force: :cascade do |t|
  ...
  create_table "sequences", id: :bigint, auto_increment: true, force: :cascade do |t|
  ...
  create_table "taxons", id: :integer, auto_increment: true, force: :cascade do |t|
  ...
  create_table "uniprot_entries", id: :integer, auto_increment: true, force: :cascade do |t|
