...
ActiveRecord::Schema[7.0].define(version: 0) do
  ...
  create_table "ec_cross_references", id: :bigint, force: :cascade do |t|
  ...
  create_table "go_cross_references", id: :bigint, force: :cascade do |t|
    t.bigint "uniprot_entry_id", null: false
  ...
  create_table "interpro_cross_references", id: :bigint, force: :cascade do |t|
    t.bigint "uniprot_entry_id", null: false
  ...
  create_table "peptides", id: :bigint, force: :cascade do |t|
  ...
  create_table "sequences", id: :bigint, force: :cascade do |t|
