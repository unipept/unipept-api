...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "ec_cross_references", id: :integer, unsigned: true, force: :cascade do |t|
    t.integer "uniprot_entry_id", null: false, unsigned: true
    t.string "ec_number_code", limit: 15, null: false
  end

  create_table "ec_numbers", id: :integer, limit: 2, unsigned: true, force: :cascade do |t|
    t.string "code", limit: 15, null: false
    t.string "name", limit: 155, null: false
  end

  create_table "embl_cross_references", id: :integer, unsigned: true, force: :cascade do |t|
    t.integer "uniprot_entry_id", null: false, unsigned: true
    t.string "protein_id", limit: 25
    t.string "sequence_id", limit: 25
  end

  create_table "go_cross_references", id: :integer, unsigned: true, force: :cascade do |t|
    t.integer "uniprot_entry_id", null: false, unsigned: true
  ...
  create_table "interpro_cross_references", id: :integer, unsigned: true, force: :cascade do |t|
    t.integer "uniprot_entry_id", null: false, unsigned: true
  ...
  create_table "lineages", primary_key: "taxon_id", id: :integer, limit: 3, unsigned: true, default: nil, force: :cascade do |t|
  ...
  create_table "peptides", id: :integer, unsigned: true, force: :cascade do |t|
  ...
  create_table "sequences", id: :integer, unsigned: true, force: :cascade do |t|
  ...
  create_table "taxons", id: :integer, limit: 3, unsigned: true, default: nil, force: :cascade do |t|
